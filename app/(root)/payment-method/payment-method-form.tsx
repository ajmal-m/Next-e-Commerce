...
import { DEFAULT_PAYMENT_MATHOD, PAYMENT_METHODS } from '@/lib/constants';
...
export default function PaymentMethodForm({preferedPaymentMethod} : { preferedPaymentMethod: string |null}) {
  const router = useRouter();

  const form = useForm<z.infer<typeof paymentMethodSchema>>({
    resolver: zodResolver(paymentMethodSchema),
    defaultValues:{
      type: preferedPaymentMethod || DEFAULT_PAYMENT_MATHOD
    }
  });
